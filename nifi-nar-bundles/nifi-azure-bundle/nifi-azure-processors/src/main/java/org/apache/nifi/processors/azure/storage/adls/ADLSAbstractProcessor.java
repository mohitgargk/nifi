...
import static org.apache.nifi.processors.azure.storage.adls.ADLSConstants.CLIENT_ID;
import static org.apache.nifi.processors.azure.storage.adls.ADLSConstants.CLIENT_SECRET;
import static org.apache.nifi.processors.azure.storage.adls.ADLSConstants.AUTH_TOKEN_ENDPOINT;
...
public abstract class ADLSAbstractProcessor extends AbstractProcessor {
    ...
    protected ADLStoreClient createADLSClientUnsafe(final ProcessContext context) {
        ...
        final ClientCredsTokenProvider clientCredsTokenProvider = new ClientCredsTokenProvider(authTokenEndPoint, clientId, clientSecret);
