...
import static org.apache.nifi.processors.azure.storage.adls.ADLSConstants.ERR_ACL_ENTRY;
import static org.apache.nifi.processors.azure.storage.adls.ADLSConstants.ERR_FLOWFILE_CORE_ATTR_FILENAME;
import static org.apache.nifi.processors.azure.storage.adls.ADLSConstants.REL_FAILURE;
import static org.apache.nifi.processors.azure.storage.adls.ADLSConstants.FILE_NAME_ATTRIBUTE;
import static org.apache.nifi.processors.azure.storage.adls.ADLSConstants.CHUNK_SIZE_IN_BYTES;
import static org.apache.nifi.processors.azure.storage.adls.ADLSConstants.ADLS_FILE_PATH_ATTRIBUTE;
...
public class PutADLSFile extends ADLSAbstractProcessor {
    ...
    protected static final PropertyDescriptor UMASK = new PropertyDescriptor.Builder()
            ...
            .description("A umask represented as an octal number which determines the permissions of files written to ADLS.")
    ...
    public void onTrigger(ProcessContext context, ProcessSession session) throws ProcessException {
        ...
        try {
            ...
            try {
                final ADLFileOutputStream fileOutputStream = createADLSFile(adlsClientFinal, tempFilePath, octalPermission);
